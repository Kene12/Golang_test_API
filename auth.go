...
func RegisterAuthRoutes(r *mux.Router) {
	...
	r.HandleFunc("/registerUser", RegisterHandler("User")).Methods("POST")
	r.HandleFunc("/registerMerchant", RegisterHandler("Merchant")).Methods("POST")
	r.HandleFunc("/registerAdmin", RegisterHandler("Admin")).Methods("POST")
